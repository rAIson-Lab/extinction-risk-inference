...
# GUARDAR BASELINE
os.makedirs('confold_results_noth1', exist_ok=True)
with open('confold_results_noth1/01_baseline.txt', 'w') as f:
    baseline_model.asp()
...
with open('confold_results_noth1/02_expert_with_confidence.txt', 'w') as f:
    expert_model.asp()
...
# LEARNED CONFIDENCE
with open('confold_results_noth1/03_expert_learned_confidence.txt', 'w') as f:
...
with open('confold_results_noth1/04_simple_pruned_model_expert_confidence.txt', 'w') as f:
...
# PRUNED MODEL
with open('confold_results_noth1/05_advanced_pruning_model.txt', 'w') as f:
...
with open('confold_results_noth1/06_expert_advanced_pruning_model.txt', 'w') as f:
