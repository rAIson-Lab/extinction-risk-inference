...
# GUARDAR BASELINE
os.makedirs('confold_results20pruning', exist_ok=True)
with open('confold_results20pruning/01_baseline.txt', 'w') as f:
    baseline_model.asp()
...
with open('confold_results20pruning/02_expert_with_confidence.txt', 'w') as f:
    expert_model.asp()
...
# LEARNED CONFIDENCE
with open('confold_results20pruning/03_expert_learned_confidence.txt', 'w') as f:
...
with open('confold_results20pruning/04_simple_pruned_model_expert_confidence.txt', 'w') as f:
...
# PRUNED MODEL
with open('confold_results20pruning/05_advanced_pruning_model.txt', 'w') as f:
...
with open('confold_results20pruning/06_expert_advanced_pruning_model.txt', 'w') as f:
