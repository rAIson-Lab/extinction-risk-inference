...
# GUARDAR BASELINE
os.makedirs('confold_results10pruning', exist_ok=True)
with open('confold_results10pruning/01_baseline.txt', 'w') as f:
    baseline_model.asp()
...
with open('confold_results10pruning/02_expert_with_confidence.txt', 'w') as f:
    expert_model.asp()
...
# LEARNED CONFIDENCE
with open('confold_results10pruning/03_expert_learned_confidence.txt', 'w') as f:
...
with open('confold_results10pruning/04_simple_pruned_model_expert_confidence.txt', 'w') as f:
...
print("--- Training with confidence_fit(improvement_threshold=0.1) ---")
...
# PRUNED MODEL
with open('confold_results10pruning/05_advanced_pruning_model.txt', 'w') as f:
...
with open('confold_results10pruning/06_expert_advanced_pruning_model.txt', 'w') as f:
