...
# Load the data
model_template, data = updated_extinction_birds(data_path='../data/birds/Avo_Birdbase.csv')

# Split into training and testing sets
train_data, test_data = split_data(data, ratio=0.9, shuffle=True)

print(f"Training set size: {len(train_data)} updatedextinctionbirds")
print(f"Testing set size: {len(test_data)} updatedextinctionbirds")
